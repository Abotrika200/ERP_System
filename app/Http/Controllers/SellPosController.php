    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (!empty($input['products'])) {
                ...
                $transaction_add=Transaction::findorfail($transaction->id);

                $transaction_add->transaction_add=$request->transaction_add;
                $transaction_add->transaction_add_value=$request->transaction_add_value;
