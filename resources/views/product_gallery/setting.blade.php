...
@section('content')
 ...
 <div class="col-sm-4">
                   <div class="form-group">
                       <br>
                       <label>
                           {!! Form::checkbox('hide_stock', 1, false, ['class' => 'input-icheck', 'id' => 'enable_stock']); !!}
                           <strong>هل تريد ايقاف المتجر</strong>
                       </label>
                   </div>
               </div>
    ...
    <script type="text/javascript">
        ...
        function fileValidation() {
           ...
           $(document).ready(function () {
            $('.input-icheck').change(function () {
                if ($(this).prop('checked')) {
                    $('.input-icheck').not(this).prop('checked', false);
                }
            });
        });
