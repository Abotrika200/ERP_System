...
<div class="col-md-3">
    <div class="form-group">
        <label>@lang('lang_v1.sku')</label>
        <div>
            <input type="number" name="sku" id="sku" class="form-control" style="width: 80%; float: left;">
            <button type="button" class="btn-search">
                <i class="fa fa-barcode"></i> <!-- الأيقونة التي تمثل الباركود -->
            </button>
        </div>
    </div>
</div>
