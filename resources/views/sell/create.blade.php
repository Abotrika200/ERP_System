						...
						<div class="col-sm-3">
							...
							<div class="form-group">
								<div class="input-group">
									...
									{!! Form::select('price_group', $price_groups, null, ['class' => 'form-control select2', 'id' => 'price_group','placeholder'=>__('lang_v1.select.pricgroup')]); !!}
									<span class="input-group-addon">
				...
				@else
					<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
						<div class="form-group">
							...
							{!! Form::select('status', ['final' => __('sale.final'), 'draft' => __('sale.draft'),'proforma' => __('lang_v1.proforma')], null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
						</div>
					</div>
				@endif
				<div class="col-sm-3">
