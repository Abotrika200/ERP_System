    ...
    <div class="col-md-6">
      ...
      <button type="button" id="view_suspended_sales" title="{{ __('lang_v1.view_suspended_sales') }}" class="btn bg-yellow btn-flat m-6 btn-xs m-5 btn-modal pull-right" data-container=".view_modal"
          data-href="{{$view_suspended_sell_url}}">
            <strong><i class="fa fa-pause-circle fa-lg"></i> مبيعات معلقة</strong>
      </button>
      ...
      @endif
        ...
        <a class="btn btn-primary btn-flat m-6 btn-xs m-5 pull-right" target="_blank" href="{{URL::to('/reports/product-sell-return-report')}}" >
            <strong>مرتجع المبيعات</strong>
        </a>
        @endcan
        
        <a class="btn btn-primary btn-flat m-6 btn-xs m-5 pull-right" target="_blank" href="/" >
