...
class Subscription extends Model
{
    ...
    */
    ...
    public static function aclog($business_id)
    {
        $date_today = \Carbon::today()->toDateString();
...
$locationCountArray = \DB::table('subscriptions')
   ...
   ->whereDate('start_date', '<=', $date_today)
    ...
    ->toArray();
        ...
        $location_count = DB::table('packages')->whereIn('id', $locationCountArray)->pluck('location_count')->sum();
