                    ...
                    <div class="col-md-4">
                        ...
                        <div class="box box-widget widget-user-2">
                            ...
                            <div class="widget-user-header bg-yellow">
                              ...
                              <h5 class="widget-user-desc"><i class="fa fa-user-secret" title="Owner"></i> {{ $business->owner->first_name??'لم يتم العثور' . ' ' . $business->owner->last_name??'لم يتم العثور'}}</h5>
                              <h5 class="widget-user-desc"><i class="fa fa-envelope" title="Owner Email"></i> {{ $business->owner->email??'لم يتم العثور'}}</h5>
                                <h5 class="widget-user-desc"><i class="fa fa-mobile" title="Owner Contact"></i> {{ $business->owner->contact_no??'لم يتم العثور' }}</h5>
                                <h5 class="widget-user-desc"><i class="fa fa-phone" title="Business Contact"></i> {{ $address->mobile??'لم يتم العثور' }}</h5>
                                <h5 class="widget-user-desc"><i class="fa fa-phone" title="Business Contact"></i> {{ $address->alternate_number??'لم يتم العثور'}}</h5>
